...
for i in range(0, len(events), BATCH_SIZE):
    ...
    req = urllib.request.Request(
        'https://store-intelligence-production-325f.up.railway.app/events/ingest',
        data=data,
...
# Show final metrics
req2 = urllib.request.Request('https://store-intelligence-production-325f.up.railway.app/stores/STORE_BLR_002/metrics')
